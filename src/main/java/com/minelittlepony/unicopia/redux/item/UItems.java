...
import com.minelittlepony.unicopia.redux.toxin.DynamicToxicBlockItem;
import com.minelittlepony.unicopia.redux.toxin.DynamicToxicItem;
import com.minelittlepony.unicopia.redux.toxin.ToxicBlockItem;
import com.minelittlepony.unicopia.redux.toxin.ToxicItem;
import com.minelittlepony.unicopia.redux.toxin.Toxicity;
import com.minelittlepony.unicopia.redux.toxin.Toxin;
...
import static com.minelittlepony.unicopia.core.EquinePredicates.*;
...
public class UItems {
    ...
    public static final Item staff_remembrance = register(new EnchantedStaffItem(new Item.Settings(), new ScorchSpell()), "staff_remembrance");
