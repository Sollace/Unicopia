...
import com.minelittlepony.unicopia.client.render.model.ModelQuads;
...
public class ModelGem extends EntityModel<SpellcastEntity> {
    ...
    public void render(SpellcastEntity entity, float time, float walkSpeed, float stutter, float yaw, float pitch, float scale) {
        ...
        if (entity.hasEffect()) {
            Color.glColor(entity.getEffect().getTint(), 1);
        }
