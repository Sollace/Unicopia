...
public class Pages extends JsonDataLoader implements IdentifiableResourceReloadListener {
    ...
    @Override
    protected void apply(Map<Identifier, JsonElement> data, ResourceManager manager, Profiler profiled) {
        pages.clear();
        data.forEach((id, json) -> pages.put(id, new PageInstance(id, json.getAsJsonObject())));
