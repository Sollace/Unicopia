...
public class SlimeDripBlock extends Block {
    ...
    @Override
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState replacement, boolean moved) {
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random rand) {
        if (state.get(SHAPE) == Shape.BULB && rand.nextInt(8) == 0) {
            Vec3d offset = state.getModelOffset(world, pos).add(pos.getX(), pos.getY(), pos.getZ());
