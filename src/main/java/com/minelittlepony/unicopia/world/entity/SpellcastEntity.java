...
import com.minelittlepony.unicopia.world.item.CastableMagicItem;
...
public class SpellcastEntity extends MobEntityWithAi implements Magical, Caster<LivingEntity>, EtherialListener, InAnimate, PickedItemSupplier {
