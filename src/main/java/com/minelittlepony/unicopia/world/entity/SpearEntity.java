...
public class SpearEntity extends ArrowEntity implements Projectile {
            ...
            if (entity.damage(damagesource, damage)) {
                if (entity instanceof LivingEntity) {
                    ...
                    if (archer != null && target != archer && target instanceof PlayerEntity && archer instanceof ServerPlayerEntity) {
                        ((ServerPlayerEntity)archer).networkHandler.sendPacket(new GameStateChangeS2CPacket(GameStateChangeS2CPacket.PROJECTILE_HIT_PLAYER, 0));
                    }
                }
