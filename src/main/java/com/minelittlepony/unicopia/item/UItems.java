...
public class UItems {
    ...
    public static final Item record_crusade = register(createRecord(USounds.RECORD_CRUSADE), "crusade");
    public static final Item record_pet = register(createRecord(USounds.RECORD_PET), "pet");
    public static final Item record_popular = register(createRecord(USounds.RECORD_POPULAR), "popular");
    public static final Item record_funk = register(createRecord(USounds.RECORD_FUNK), "funk");
